...
var HTMLsummarySection = '<div >%data%</div>';
...
var HTMLprojectImage = '<img data-toggle="modal" data-target="%modal_id%" class="image-shadow img-responsive imgBox" src="%data%">';
var HTMLprojectImageId = '#project'
